...
-- CONFIG BEGINS HERE --
local arena = {
  frompos = {x = 121, y = 45, z = 10},
  topos = {x = 129, y = 50, z = 10},
  exitpos = {x = 125, y = 43, z = 9}
}
local checkpvparena = true -- checks if someone is blocking the arena
local duel_limit = 10 * 60 -- in seconds
local player1pos = {x = 119, y = 47, z = 9}
local leverpos = {x = 119, y = 46, z = 9}
local player2pos = {x = 130, y = 47, z = 9}
local nplayer1pos = {x = 121, y = 47, z = 10}
local nplayer2pos = {x = 128, y = 47, z = 10}
-- CONFIG ENDS HERE --
