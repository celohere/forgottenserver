SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position(563, 248, 6),
	rewardPosition = Position(534, 231, 6),
	...
	itemPillar = 1354,
	itemTeleport = 1387,
	itemsNotErasable = {7465, 1354, 1543, 1544, 1545},
}

-- Script automatically derives other pit positions from this one
local firstPit = {
	fromPos = {x = 517, y = 245, z = 7},
	toPos = {x = 526, y = 254, z = 7},
	center = {x = 522, y = 249, z = 7},
	pillar = {x = 516, y = 249, z = 7},
	tp = {x = 516, y = 249, z = 7},
	summon = {x = 522, y = 251, z = 7}
}
